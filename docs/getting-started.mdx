...
You are responsible for selecting a model, provider, and channel appropriate for your data and use case, and for complying with any applicable model-provider [terms](https://vercel.com/ai-gateway/models) and data-processing requirements.
...
Before using real customer data, confirm the selected model provider terms, routing path, and retention settings are appropriate for that data.
