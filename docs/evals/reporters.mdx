...
Only configure reporters for destinations approved for the data in the eval run. Eval inputs, outputs, scores, metadata, and errors can contain user or customer data.
